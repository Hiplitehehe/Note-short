...
export function renderLogin(siteKey: string) {
  return new Response(\`<!DOCTYPE html>
<html>
<head><title>Login</title><script src="https://www.google.com/recaptcha/api.js" async defer></script></head>
<body>
<h2>Login</h2>
...
export function renderSignup(siteKey: string) {
  return new Response(\`<!DOCTYPE html>
<html>
<head><title>Signup</title><script src="https://www.google.com/recaptcha/api.js" async defer></script></head>
<body>
<h2>Signup</h2>
